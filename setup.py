...
setup(
    console = [{
        "script":"OnceAnHour.py",
        "icon_resources":[(1, "dragonstomper_test2.ico"), (0, "dragonstomper_test2.ico")],
        "dest_base":"OnceAnHour"}],
      data_files=my_files,
      zipfile=None,
      options=opts,
)
